...
#GFM_CONST_IMF=1                        #0 for Chabrier (default), 1 for a pure power-law (requires parameter IMFslope, e.g. -2.35 for Salpeter), 2 for Kroupa (2001)
...
#GFM_METALLICITY_IN_ICS                 #gas metallicity and abundance info is contained in the ICs file
