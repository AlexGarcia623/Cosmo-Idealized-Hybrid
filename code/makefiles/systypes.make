...
ifeq ($(SYSTYPE), "matrix")
  CC       = mpicc     # sets the C compiler
  OPT     += -DMPICH_IGNORE_CXX_SEEK
  OPTIMIZE = -std=c11 -O3 -Wall -Wno-unused-but-set-variable -Wno-uninitialized -Wno-unknown-pragmas -Wno-unused-function -mtune=native -march=native -m64
  MPICHINCL= -I/usr/lib/x86_64-linux-gnu/openmpi/include/
  MPICHLIB = -L/usr/lib/x86_64-linux-gnu/openmpi/lib/ -lmpi
  GSL_INCL  =
