...
integertime get_timestep_stellarevolution(int p)
{
   ...
   * 1% of the luminosity budget per time step
   * */
  if((age + 0.01 * All.InputTimeHeatRadiationFeedback) < All.InputTimeHeatRadiationFeedback)
    dtSN = fmax(dtSN, 0.01 * All.InputTimeHeatRadiationFeedback);
#endif
