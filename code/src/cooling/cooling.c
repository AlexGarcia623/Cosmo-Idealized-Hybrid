...
#endif
      //redshift = 0.0;  //JONAH EDIT - change redshift for uv background 
      // SetZeroIonization();
      // return;
    }
...
#else
  //if (get_hydrogen_abundances_of_local_cell(i) == 0)
  //{
  //    printf("No Hydrogen, %g, %g, %g\n", SphP[i].MetalsFraction[0], SphP[i].MetalsFraction[1], SphP[i].MetalsFraction[2]); //JONAH EDUT
  //}
  //printf("Test 3, %llu \n", i); //JONAH EDIT
