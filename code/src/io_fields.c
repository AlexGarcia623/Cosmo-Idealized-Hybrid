...
static void io_func_nh(int particle, int components, void *buffer, int mode)
{
  ...
  if (mode == 0) //JONAH EDIT
  {
    ...
    ((MyOutputFloat *)buffer)[0] = nh0;
      ...
      printf("Test NH0");
      //SphP[particle].xh = ((MyInputFloat *)buffer)[0]; //JONAH EDIT
  }
}
#endif
...
void init_io_fields(void)
{
  ...
  //init_field(IO_NH, "NH  ", "NeutralHydrogenAbundance", MEM_NONE, FILE_MY_IO_FLOAT, FILE_NONE, 1, A_NONE, 0, io_func_nh, GAS_ONLY); //JONAH EDIT
  //init_field(IO_NH, "NH  ", "NeutralHydrogenAbundance", MEM_NONE, FILE_MY_IO_FLOAT, FILE_MY_IO_FLOAT, 1, A_NONE, 0, io_func_nh, GAS_ONLY); // JONAH EDIT
