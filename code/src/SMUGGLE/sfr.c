  ...
  for(idx = 0; idx < TimeBinsHydro.NActiveParticles; idx++)
    {
      ...
      if (SphP[i].MetalsFraction[element_index("Hydrogen")] == 0){
          printf("Test bad sfr %d\n \
                  Volume %g \n \
                  MassMetals %g %g %g \n \
                  Mass Metallicity %g \n \
                  Metals Fraction %g %g  %g \n \
                  Metallicity %g \n \
                  OldMass  %g \n \
                  Density %g \n \
                  Center %g %g %g \n \
                  Sfr %g \n \
                  \n", i, SphP[i].Volume, SphP[i].MassMetals[0], SphP[i].MassMetals[1], SphP[i].MassMetals[2], SphP[i].MassMetallicity, SphP[i].MetalsFraction[0], SphP[i].MetalsFraction[1], SphP[i].MetalsFraction[2],  SphP[i].Metallicity, SphP[i].OldMass, SphP[i].Density, SphP[i].Center[0], SphP[i].Center[1], SphP[i].Center[2], SphP[i].Sfr); //JONAH EDIT
      }else{
          /*
          printf("Test good sfr %d\n \
                  Volume %g \n \
                  MassMetals %g %g %g \n \
                  Mass Metallicity %g \n \
                  Metals Fraction %g %g  %g \n \
      ...
      */
      ...
      /* to protect against SF at too high redshift */
      if(All.ComovingIntegrationOn)
